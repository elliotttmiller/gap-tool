  ...
  variants: {
    variant: {
      primary: [
        ...
        "hover:bg-[#188a89] dark:hover:bg-[#188a89]",
      ...
      secondary: [
        ...
        "text-gray-50",
        "bg-gray-900",
        "hover:border-[#1db8b9]/50 hover:bg-[#1db8b9]/15 hover:text-[#1db8b9] dark:hover:text-white",
      ...
      ghost: [
        ...
        "border-transparent",
        "text-gray-900 dark:text-gray-50",
        "bg-transparent hover:bg-[#1db8b9]/15 hover:text-[#1db8b9] dark:hover:text-white",
