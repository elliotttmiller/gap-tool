      ...
      <Card className="space-y-8 p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
            <Field label="Emergency savings ($)"><Input type="number" min={0} value={form.emergencySavings} onChange={(event) => setField("emergencySavings", event.target.value)} /></Field>
            ...
            <Field label="Home equity ($)"><Input type="number" min={0} value={form.homeEquity} onChange={(event) => setField("homeEquity", event.target.value)} /></Field>
          </div>
        </div>
