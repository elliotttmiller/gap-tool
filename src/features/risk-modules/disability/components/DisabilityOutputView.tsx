            ...
            <CardHeader className="shrink-0 px-6 pt-5 pb-0">
              <div className="grid gap-3">
                ...
                <div className="flex min-h-8 items-center gap-3">
                  ...
                  {onAssumptionsChange ? (
                    <button type="button" onClick={toggleCola} aria-pressed={colaRemoved} title={colaRemoved ? "Restore COLA benefit growth" : "Remove COLA from this comparison"} className="group ml-auto flex shrink-0 items-center gap-2.5 rounded-full border border-[#cbdadd] bg-white py-1.5 pr-1.5 pl-3 text-left text-[#202024] shadow-sm transition-colors hover:border-brand-500 hover:bg-brand-50 dark:border-white/20 dark:bg-[#343438] dark:text-white dark:hover:border-white/35 dark:hover:bg-[#3f3f43]">
