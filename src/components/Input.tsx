  ...
  ({ className, inputClassName, hasError, enableStepper = true, type, ...props }, forwardedRef) => {
    ...
    return (
      <div className={cx("relative w-full", className)}>
        ...
        />
        {isSearch && (
          <div className={cx("pointer-events-none absolute bottom-0 left-2 flex h-full items-center justify-center", "text-gray-400 dark:text-gray-600")}>
        ...
        {isPassword && (
          <div className={cx("absolute bottom-0 right-0 flex h-full items-center justify-center px-3")}>
            <button
              ...
              className={cx("h-fit w-fit rounded-sm outline-none transition-all", "text-gray-400 dark:text-gray-600", "hover:text-gray-500 hover:dark:text-gray-500", focusRing)}
              type="button"
