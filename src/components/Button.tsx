  ...
  variants: {
    variant: {
      ...
      secondary: [
        ...
        "text-gray-50",
        "bg-gray-900",
        "hover:border-[#188a89]/40 hover:bg-[#188a89]/15 hover:text-[#188a89] dark:hover:text-white",
      ...
      ghost: [
        ...
        "border-transparent",
        "text-gray-900 dark:text-gray-50",
        "bg-transparent hover:bg-[#188a89]/15 hover:text-[#188a89] dark:hover:text-white",
