    ...
    if (this.state.error) {
      return (
        <div className="mx-auto mt-4 max-w-4xl rounded-2xl border border-[#f15a29]/45 bg-white p-8 text-center shadow-lg dark:bg-[#32373f]">
          <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-full bg-[#f15a29]/12 text-xl font-bold text-[#f15a29] dark:bg-[#f15a29]/20" aria-hidden="true">!</div>
          ...
          <div className="mx-auto mt-4 max-w-2xl rounded-lg border border-[#f15a29]/25 bg-[#f15a29]/8 px-4 py-3 text-left">
            <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#f15a29]">Error details</p>
