      ...
      >
        ...
        {fillRatio > 0 && (
          <rect
            ...
            style={{
              ...
              animation: "reserve-fill-rise 1100ms cubic-bezier(0.22, 1, 0.36, 1) 300ms both",
            }}
          />
        )}
        ...
        {fillRatio > 0 && fillRatio < 1 && (
          <line
            x1={bucketX - 4}
            y1={fillTopY}
            x2={bucketX + bucketW + 4}
            y2={fillTopY}
            stroke="#ffffff"
            strokeWidth={1}
            strokeOpacity={0.35}
            strokeDasharray="3 3"
            style={{ animation: "reserve-line-draw 700ms ease-out 950ms both" }}
          />
        )}
