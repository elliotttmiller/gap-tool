...
The application intentionally does not provide PWA installation, a web-app manifest, a service worker, offline caching, or an app-update prompt. Startup removes legacy Gap Tool workers and Workbox caches left by earlier deployments.
