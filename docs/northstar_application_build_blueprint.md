...
Build the following reusable components early:
...
```txt
Start by creating the NorthStar MVP application scaffold using Next.js, TypeScript, Tailwind CSS, shadcn/ui conventions, and a modular /src architecture.
