      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        <Card className="border-slate-200">
          <CardContent className="p-5">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Severance & Assets</div>
            <div className="text-2xl font-bold tracking-tight text-slate-900">
              {formatCurrency(outputs.severanceTotal + (outputs.timeline[0]?.reserveBalance || 0) - outputs.severanceTotal)}
            </div>
            <p className="text-[10px] text-slate-500 mt-1">Starting liquidity buffer</p>
          </CardContent>
        </Card>
        
        <Card className="border-slate-200">
          <CardContent className="p-5">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Cash Depletion Month</div>
            ...
            <p className="text-[10px] text-slate-500 mt-1">Months until $0 savings</p>
          </CardContent>
        </Card>

        <Card className="border-slate-200 sm:col-span-2 md:col-span-1">
          <CardContent className="p-5">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Total Search Shortfall</div>
            <div className="text-2xl font-bold tracking-tight text-rose-600">
              {formatCurrency(outputs.totalUncoveredShortfall)}
            </div>
            <p className="text-[10px] text-slate-500 mt-1">Unfunded gap across search</p>
          </CardContent>
        </Card>
      </div>
